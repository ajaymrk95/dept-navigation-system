import type { Building, Floor, Room, AdminLog } from '../types';

export const BUILDING_GEOJSON = {
...
export const initialBuildings: Building[] = [
  {
    id: 'b1',
    name: 'Electronics & Hardware Lab Complex',
    shortName: 'ELHC',
    description: 'Main electronics and hardware laboratory complex housing undergraduate labs and classrooms.',
    location: 'NIT Calicut, Kozhikode, Kerala',
    totalFloors: 3,
    yearBuilt: 2005,
  ...
  },
  {
    ...
    shortName: 'MAB',
    description: 'Central academic block with lecture halls and faculty offices.',
    location: 'NIT Calicut, Kozhikode, Kerala',
    totalFloors: 5,
    yearBuilt: 1998,
    geojson: {},
  ...
  },
  {
    ...
    shortName: 'CSD',
    description: 'CS department with computer labs and seminar halls.',
    location: 'NIT Calicut, Kozhikode, Kerala',
    totalFloors: 4,
    yearBuilt: 2010,
    geojson: {},
...
export const initialFloors: Floor[] = [
  {
    ...
    floorNumber: 1,
    label: 'Ground Floor',
    pathJson: PATH_GEOJSON,
    poiJson: POI_GEOJSON,
    unitsJson: UNITS_GEOJSON,
...
export const initialRooms: Room[] = [
  { id: 'r1', buildingId: 'b1', floorId: 'f1', roomNo: '101', name: 'ELHC 101', category: 'classroom', capacity: 60, description: 'Main lecture classroom', navigable: true, level: 1 },
  { id: 'r2', buildingId: 'b1', floorId: 'f1', roomNo: '102', name: 'ELHC 102', category: 'classroom', capacity: 60, description: 'Lecture room', navigable: true, level: 1 },
  { id: 'r3', buildingId: 'b1', floorId: 'f1', roomNo: '103', name: 'ELHC 103', category: 'classroom', capacity: 60, description: 'Lecture room', navigable: true, level: 1 },
  { id: 'r4', buildingId: 'b1', floorId: 'f1', roomNo: '104', name: 'ELHC 104', category: 'classroom', capacity: 60, description: 'Lecture room', navigable: true, level: 1 },
  { id: 'r5', buildingId: 'b1', floorId: 'f1', roomNo: null as unknown as string, name: 'Ladies Toilet', category: 'toilet', navigable: false, level: 1 },
  { id: 'r6', buildingId: 'b1', floorId: 'f1', roomNo: null as unknown as string, name: 'Gents Toilet', category: 'toilet', navigable: false, level: 1 },
  { id: 'r7', buildingId: 'b2', floorId: 'f4', roomNo: '201', name: 'MAB 201', category: 'hall', capacity: 120, description: 'Seminar hall', navigable: true, level: 1 },
];

export const initialLogs: AdminLog[] = [
  { id: 'l1', action: 'LOGIN', entity: 'Auth', entityId: '-', detail: 'Admin logged in', timestamp: '2025-03-10T08:30:00Z', admin: 'admin@nitc.ac.in' },
  { id: 'l2', action: 'CREATE', entity: 'Room', entityId: 'r1', detail: 'Created room ELHC 101 in ELHC Ground Floor', timestamp: '2025-03-10T09:00:00Z', admin: 'admin@nitc.ac.in' },
  { id: 'l3', action: 'UPDATE', entity: 'Floor', entityId: 'f1', detail: 'Updated path JSON for ELHC Ground Floor', timestamp: '2025-03-10T09:45:00Z', admin: 'admin@nitc.ac.in' },
  { id: 'l4', action: 'CREATE', entity: 'Building', entityId: 'b3', detail: 'Added new building CSD', timestamp: '2025-03-09T14:00:00Z', admin: 'admin@nitc.ac.in' },
  { id: 'l5', action: 'DELETE', entity: 'Room', entityId: 'r8', detail: 'Deleted unused room assignment', timestamp: '2025-03-08T11:00:00Z', admin: 'admin@nitc.ac.in' },
  { id: 'l6', action: 'UPDATE', entity: 'Building', entityId: 'b1', detail: 'Updated ELHC floor count to 3', timestamp: '2025-03-07T16:30:00Z', admin: 'admin@nitc.ac.in' },
];
